...
const {
  login, refresh, logout, changePassword, getMe,
...
const {
  getClasses, getClass, createClass, updateClass, deleteClass, getEligibleStudents,
...
const {
  getDashboardStats, getStudentAnalytics, getAttendanceTrends, getModificationsSummary,
} = require('../controllers/analyticsController');
const {
  getDailyReport, getClassReport, getStudentReport, getTeacherReport, getVolunteerReport, getFullYearReport,
...
// Student attendance
router.get('/attendance/students', protect, getStudentAttendance);
...
router.get('/settings/active', getActiveSettings); // Public (for home page countdown)
