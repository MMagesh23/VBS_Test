...
// Auto-determine category from grade for staging student
...
const StagingStudent = mongoose.model('StagingStudent', stagingStudentSchema);
const StagingTeacher = mongoose.model('StagingTeacher', stagingTeacherSchema);
const StagingVolunteer = mongoose.model('StagingVolunteer', stagingVolunteerSchema);
